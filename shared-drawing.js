...
class SharedDrawing {
    ...
    getCellPointerPosition(e, cellKey) {
        ...
        // ALWAYS get fresh rect - no caching to avoid offset issues
        ...
        // ALSO store the aspect ratio at time of drawing for compensation
        const percentage = {
            ...
            aspectRatio: canvasRect.width / canvasRect.height, // Store aspect ratio
            t: Date.now()
        };
        ...
        this.showDebugInfo(
            ...
            `Canvas: ${canvasRect.width.toFixed(1)}×${canvasRect.height.toFixed(1)}\n` +
            ...
            `Aspect: ${percentage.aspectRatio.toFixed(3)}`
        );
