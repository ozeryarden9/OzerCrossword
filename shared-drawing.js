...
class SharedDrawing {
    ...
    getCellPointerPosition(e, cellKey) {
        ...
        this.showDebugInfo(
            ...
            `Aspect: ${(canvasRect.width / canvasRect.height).toFixed(3)}`
        );
    ...
    drawStrokeSegmentInCell(cellKey, p1, p2) {
        ...
        // ALWAYS use current device's canvas dimensions for drawing
        // Since ctx.scale(dpr, dpr) normalizes to CSS pixels, this works perfectly
        const rect = canvas.getBoundingClientRect();
        
        // Convert percentage to CSS pixels on THIS device
        ...
        // Thinner line width that looks good on all devices
        // Since ctx is scaled by DPR, 1.0 CSS pixel is a good thin line
        ctx.lineWidth = 1.0;
