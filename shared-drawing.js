...
class SharedDrawing {
    ...
    handleCellPointerDown(e, cellKey) {
        ...
        // Cache the cell rect at START of stroke to prevent shifts during drawing
        const { cell } = this.cellCanvases[cellKey];
        this.currentCellRect = cell.getBoundingClientRect();
    ...
    getCellPointerPosition(e, cellKey) {
        ...
        // Use cached rect during drawing, or get fresh one
        const cellRect = this.currentCellRect || cell.getBoundingClientRect();
