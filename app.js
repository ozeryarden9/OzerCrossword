...
class CrosswordApp {
    ...
    setupEventListeners() {
        ...
        document.getElementById('grid-right').addEventListener('input', () => this.updateGridPreview());
        document.getElementById('grid-top').addEventListener('input', () => this.updateGridPreview());
        document.getElementById('grid-width').addEventListener('input', () => this.updateGridPreview());
        document.getElementById('grid-height').addEventListener('input', () => this.updateGridPreview());
    ...
    async loadTemplateImage(file) {
        try {
            ...
            document.getElementById('grid-preview-image').src = imageData;
    ...
    updateGridPreview() {
        ...
        const right = parseInt(document.getElementById('grid-right').value) || 10;
        const top = parseInt(document.getElementById('grid-top').value) || 10;
        const width = parseInt(document.getElementById('grid-width').value) || 80;
        const height = parseInt(document.getElementById('grid-height').value) || 80;
        const showLines = document.getElementById('show-grid-lines').checked;

        const overlay = document.getElementById('grid-preview-overlay');
        ...
        if (showLines) {
            overlay.classList.add('show-lines');
        } else {
    ...
    async saveSettings() {
        ...
        const right = parseInt(document.getElementById('grid-right').value);
        const top = parseInt(document.getElementById('grid-top').value);
        ...
        const gridSettings = {
            rows,
            cols,
            position: { right, top, width, height }
        };
    ...
    async resetGrid() {
        ...
        document.getElementById('grid-right').value = 10;
        document.getElementById('grid-top').value = 10;
        document.getElementById('grid-width').value = 80;
        document.getElementById('grid-height').value = 80;
    ...
    async loadSettingsScreen() {
        ...
        document.getElementById('grid-right').value = gridSettings.position.right;
        document.getElementById('grid-top').value = gridSettings.position.top;
        document.getElementById('grid-width').value = gridSettings.position.width;
        document.getElementById('grid-height').value = gridSettings.position.height;
