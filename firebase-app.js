...
class CrosswordApp {
    ...
    async enterRoom(roomId, room) {
        ...
        crosswordImage.crossOrigin = 'anonymous'; // Allow OpenCV to read image data
        ...
        // Initialize clue marking system with auto-detection
        // IMPORTANT: Must run AFTER image loads and grid is positioned
        if (!this.clueMarking) {
            this.clueMarking = new ClueMarking();
        }
        
        // Get grid bounds for clue detection (area outside grid)
        const gridBounds = this.crosswordGrid.container.getBoundingClientRect();
        
        // Initialize with auto-detection
        this.clueMarking.initialize(roomId, crosswordImage, gridBounds, true);
