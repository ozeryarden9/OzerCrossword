...
class CrosswordApp {
    ...
    async testMyScriptConnection() {
        ...
        try {
            ...
            // Test with a simple stroke
            const testStrokes = [[[100, 100, 0], [150, 150, 100], [200, 100, 200]]];
            ...
            if (response.ok) {
                ...
                notifier.error('המפתחות שגויים - בדוק שהעתקת נכון');
            }
        } catch (error) {
